...
let card;
let servValue = 1.0;
export async function seacrhapi(term) {
  try {
...
function displaysearch() {
            ...
            >
              <div class="relative h-48 overflow-hidden">
                ...
                <div class="absolute bottom-3 left-3 flex gap-2">
                  ...
                  <span
                    class=" ${searchmeals[i].area == null ? "loading" : ""}  px-2 py-1 bg-emerald-500 text-xs font-semibold rounded-full text-white"
                  >
                     ${searchmeals[i].area}
                  </span>
                </div>
                ...
                <div class="flex items-center justify-between text-xs">
                  ...
                  <span class="font-semibold text-gray-500">
                    <i class="fa-solid fa-globe text-blue-500 mr-1"></i>
                     ${searchmeals[i].area == null ? "international" : searchmeals[i].area} 
                  </span>
                </div>
              </div>
            </div>
  ...
  count.innerHTML = ` Showing ${searchmeals.length} recipes`;
  recipes.classList.add("grid", "grid-cols-4", "gap-5");
  recipes.innerHTML = cart;
  card = document.querySelectorAll(" .recipe-card");
}

window.layerappear4 = function (index) {
  let cart = "";
  cart = `
              ...
              <div class="absolute bottom-0 left-0 right-0 p-8">
                <div class="flex items-center gap-3 mb-3">
                  <span
                    ...
                    >${searchmeals[index].category}</span
                  >
                  <span
                    class="px-3 py-1  ${searchmeals[index].area == null ? "loading" : ""}  bg-blue-500 text-white text-sm font-semibold rounded-full"
                    >${searchmeals[index].area}</span
                  >
                  
                </div>
                <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">
                 ${searchmeals[index].name}
                </h1>
...
`;
  let cart2 = "";
  for (let i = 0; i < searchmeals[index].ingredients.length; i++) {
    cart2 += ` <div
                  ...
                  >
                    ...
                    <span class="text-gray-700">
                      <span class="font-medium text-gray-900">${searchmeals[index].ingredients[i].measure} </span>
                      ${searchmeals[index].ingredients[i].ingredient}
                    </span>
                  </div>`;
  }
  ...
  let cart3 = "";
  let num = 0;
  for (let i = 0; i < searchmeals[index].instructions.length; i++) {
    num += 1;
    cart3 += ` <div
                  ...
                  >
                    ...
                    <p class="text-gray-700 leading-relaxed pt-2">
                       ${searchmeals[index].instructions[i]}
                    </p>
                  </div>`;
  }

  vedio.innerHTML = `  <iframe
                    src="${searchmeals[index].youtube.replace("watch?v=", "embed/")}"
  ...
  ingredcount.innerHTML = `${searchmeals[index].ingredients.length} items`;
...
window.log4 = function (index) {
  let details = {
    image: searchmeals[index].thumbnail,
